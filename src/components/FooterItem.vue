      ...
      <div class="brand-section">
        ...
        <div class="text-container" :style="{ color: colors.text }">
          ...
          <div class="social-icons">
            <div class="icon">
              <span class="mdi mdi-gmail zc"></span>
            </div>
            <div class="icon">
      ...
      <div class="lists-section" :style="{ color: colors.text }">
        <div class="f-c">
          ...
          <div class="items-container">
            <div class="item">Desarrollo web</div>
            <div class="item">Desarrollo de apps</div>
            <div class="item">Servicios SAP</div>
            <div class="item">Explorar más</div>
          </div>
        </div>
        <div class="f-c">
        ...
        <div class="f-c">
          ...
          <div class="items-container">
            <div class="item">Sobre nosotros</div>
            <div class="item">Misión</div>
            <div class="item">Nuestros lideres</div>
          </div>
        </div>
        <div class="f-c">
          <div class="title" :style="{ color: colors.title }">LEGAL</div>
          <div class="items-container">
            <div class="item">Términos de servicios</div>
            <div class="item">Políticas de privacidad</div>
          </div>
        </div>
      </div>
    </div>
